    ...
    <>
        ...
        <div className="bg-[#EFF7FA] flex  justify-center items-center">
            <div className='w-full md:w-[75%] md:flex md:flex-row '>
                ...
                <div className="relative flex-2/4 w-full md:w-1/2 mx-auto p-4">
                   <div className='relative'>
                    ...
                    <div className="text-gray-400 space-y-4 text-xs leading-relaxed">
                        ...
                        <Link to="/blogdetails" element={<BlogDetails/>}>
                            <div className='text-lg text-green-500 font-normal flex items-center'>
                ...
                {/* Video Section */}
                <div className="relative aspect-w-16 aspect-h-16 w-full mt-6">
                    <iframe
                    className="rounded-xs shadow-md w-full h-100"
                    src="https://www.youtube.com/embed/a3Mc4PLoiNg"
                    title="YouTube video"
                ...
                {/* Content start here */}
                <div>
                    <div className="bg-white p-6 rounded-xs shadow-md space-y-4 max-w-3xl mx-auto">
                    {/* Title */}
                    <h1 className="text-2xl font-semibold text-gray-800">
                    ...
                    <div className="text-gray-400 space-y-4 text-xs leading-relaxed">
                        <p>
                        Cras sapien diam, scelerisque ut ornare a, viverra sit amet magna.
                        Mauris sapien dolor, aliquam tristique nulla vitae, ornare bibendum
                        massa. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam
                        ut enim tincidunt, vulputate velit ac, fringilla lacus.
                        </p>
                ...
                <div className="relative aspect-w-16 aspect-h-16 w-full mt-6">
                    <iframe
                    className="rounded-xs shadow-md w-full h-100"
                    src="https://www.youtube.com/embed/Fj6cr3FO2JI"
                    title="YouTube video"
                    allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                    allowFullScreen
                    ></iframe>
